...
![enter description here][3]
 ...
 4：host_Mod ==> 对应host执行的规则过滤（url,referer,useragent,network）
...

{
  ...
  "autoSync":{"state":"Master/Slave/off","timeAt":10},
  #集群同步设置，Master表示为主服务器，定时推送配置到redis,Slave表示定时从redis拉取配置  
  ...
  "denyMsg" : {"state":"on","msg":"deny by openstar","http_code":403}
 ...
 ```
{
 ...
 ```
  ...
  7：reluastr ==> 表示返回lua字符串执行（使用loadstring）
